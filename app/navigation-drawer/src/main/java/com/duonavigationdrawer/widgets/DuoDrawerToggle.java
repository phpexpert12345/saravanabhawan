package com.duonavigationdrawer.widgets;
...
import com.duonavigationdrawer.views.DuoDrawerLayout;
...
public class DuoDrawerToggle implements DrawerListener {
    ...
    // used in toolbar_home mode when DrawerToggle is disabled
     ...
     * @param toolbar                   The toolbar_home to use if you have an independent Toolbar.
     * @param duoDrawerLayout           The DrawerLayout to link to the given Activity's ActionBar
     * @param openDrawerContentDescRes  A String resource to describe the "open drawer" action
     *                                  for accessibility
     * @param closeDrawerContentDescRes A String resource to describe the "close drawer" action
