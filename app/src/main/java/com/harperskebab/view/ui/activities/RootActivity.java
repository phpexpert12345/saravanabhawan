...
public class RootActivity extends Activity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    List<UsageEvents.Event> lsEvent = new ArrayList<UsageEvents.Event>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        destLatitude = getIntent().getDoubleExtra("LATITUDE", 0.0);
...
//                    supportMapFragment.getMapAsync(RootActivity.this);
                }
            }
        });
    }
    ...
    public  String getLocationStringAddress(LatLng latLng){
        Geocoder geocoder = new Geocoder(RootActivity.this, Locale.getDefault());
        String result = null;
        try {
//                    latitude=23.0590869;
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String,String>>> >{
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            mMap.addMarker(new MarkerOptions()
                    ...
                    .title(getLocationStringAddress(new LatLng(destLatitude, destLongitude)))
